...
internal sealed partial class TrayIconService
{
        ...
        if (showSystemTrayIcon ?? false)
        {
            ...
            if (_trayIconData is null)
            {
                ...
                _trayIconData = new NOTIFYICONDATAW()
                {
                    ...
                    szTip = "Deskband 11", //RS_.GetString("AppStoreName"),
                };
            }
            ...
            if (_popupMenu is null)
            {
                ...
                PInvoke.InsertMenu(_popupMenu, 0, MENU_ITEM_FLAGS.MF_BYPOSITION | MENU_ITEM_FLAGS.MF_STRING, PInvoke.WM_USER + 1, "Settings" /*RS_.GetString("TrayMenu_Settings")*/);
                PInvoke.InsertMenu(_popupMenu, 1, MENU_ITEM_FLAGS.MF_BYPOSITION | MENU_ITEM_FLAGS.MF_STRING, PInvoke.WM_USER + 2, "Exit" /*RS_.GetString("TrayMenu_Close")*/);
            }
        }
        else
        {
    ...
    {
        string exePath = Path.Combine(AppContext.BaseDirectory, "Deskband11.exe");
