...
internal static class ResultHelper
{
    ...
    internal static List<WindowWalkerListItem> GetResultList(List<SearchResult> searchControllerResults, bool isKeywordSearch)
    {
        ...
        List<WindowWalkerListItem> resultsList = new(searchControllerResults.Count);
    ...
    {
        WindowWalkerListItem item = new(searchResult.Result)
        {
    ...
    private static string GetSubtitle(Window window)
    {
        ...
        string subtitleText = string.Empty;//  Resources.windowwalker_Running + ": " + window.Process.Name;
