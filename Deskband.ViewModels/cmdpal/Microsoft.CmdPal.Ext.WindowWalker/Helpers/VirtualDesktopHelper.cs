...
public class VirtualDesktopHelper
{
    ...
    //private static readonly CompositeFormat VirtualDesktopHelperDesktop = System.Text.CompositeFormat.Parse(Resources.VirtualDesktopHelper_Desktop);
    ...
    public void UpdateDesktopList()
    {
        ...
        {
            byte[]? allDeskValue = (byte[]?)virtualDesktopKey.GetValue("VirtualDesktopIDs", null) ?? Array.Empty<byte>();
        ...
        string virtualDesktopsKeyName = _isWindowsEleven ? registryExplorerVirtualDesktops : registrySessionVirtualDesktops;
        ...
        {
            object? currentVirtualDesktopValue = virtualDesktopsKey.GetValue("CurrentVirtualDesktop", null);
    ...
    public string GetDesktopName(Guid desktop)
    {
        ...
        //string defaultName = string.Format(System.Globalization.CultureInfo.InvariantCulture, VirtualDesktopHelperDesktop, GetDesktopNumber(desktop));
        ...
        //object? desktopName = deskSubKey?.GetValue("Name");
    ...
    public VirtualDesktopAssignmentType GetWindowDesktopAssignmentType(IntPtr hWindow, Guid? desktop = null)
    {
        ...
        {
            return isOnCurrentDesktop == 1 ? VirtualDesktopAssignmentType.CurrentDesktop : VirtualDesktopAssignmentType.OtherDesktop;
        }
    }
    ...
    public bool MoveWindowToDesktop(IntPtr hWindow, ref Guid desktopId)
    {
        ...
        int hr = _virtualDesktopManager.MoveWindowToDesktop(hWindow, ref desktopId);
    ...
    private VDesktop CreateVDesktopInstance(Guid desktop, IntPtr hWindow = default)
    {
        ...
        {
            Id = desktop,
            Name = isAllDesktops ? "all" : GetDesktopName(desktop),
