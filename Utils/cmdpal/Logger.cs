...
namespace ManagedCommon
{
    public static class Logger
    {
        ...
        public static void InitializeLogger(string applicationLogPath, bool isLocalLow = false)
        {
            ...
            string logFilePath = Path.Combine(versionedPath, "Log_" + DateTime.Now.ToString(@"yyyy-MM-dd", CultureInfo.InvariantCulture) + ".log");
        ...
        {
            string basePath = Utilities.BaseSettingsPath(applicationLogPath);
            //string basePath = isLocalLow
            //    ? Environment.GetEnvironmentVariable("userprofile") + "\\appdata\\LocalLow\\Microsoft\\zadjii" + applicationLogPath
            //    : Constants.AppDataPath() + applicationLogPath;
        ...
        private static void DeleteOldVersionLogFolders(string basePath, string currentVersionPath)
        {
            try
            {
                ...
                List<DirectoryInfo> dirs = Directory.GetDirectories(basePath)
