            ...
            else
            {
                ...
                @this._queue.TryEnqueue(async void () =>
                {
                    try
                    {
                        ...
                        SourceRequestedEventArgs eventArgs = new(e.NewValue, requestedTheme);
                        ...
                        IconData? iconData = eventArgs.Key switch
                        {
                            IconData key => key,
                            IconInfo info => requestedTheme == ElementTheme.Light ? info.Light : info.Dark,
                            _ => null,
                        };
